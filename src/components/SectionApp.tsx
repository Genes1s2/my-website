        ...
        <div>
            <section className="bg-gray-100 dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16 text-left">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Découvrez nos services numériques pour propulser votre entreprise vers l'avenir.</h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Chez Genesis, nous nous concentrons sur les marchés où la technologie, l’innovation et le capital peuvent générer de la valeur à long terme et stimuler la croissance économique.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 text-left">
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Solutions sur mesure pour le développement web et mobile.</h3>
                            <p className="text-gray-500 dark:text-gray-400">Nous créons des sites web dynamiques qui captivent et engagent vos utilisateurs.</p>
                        </div>
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Développement d'applications mobiles pour tous vos besoins professionnels.</h3>
                            <p className="text-gray-500 dark:text-gray-400">Nos applications sont conçues pour offrir une expérience utilisateur exceptionnelle.</p>
                        </div>
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Services digitaux variés pour soutenir votre croissance en ligne.</h3>
                            <p className="text-gray-500 dark:text-gray-400">De la stratégie numérique à la mise en œuvre, nous sommes à vos côtés.</p>
                        </div>
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Logiciel à l'épreuve des audits conçu pour les opérations financières critiques telles que la clôture de fin de mois et la budgétisation trimestrielle.</p>
                        </div>
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Conception d'entreprise</h3>
                            <p className="text-gray-500 dark:text-gray-400">Créez des expériences magnifiques et agréables pour le marketing et le produit grâce à une véritable collaboration inter-entreprises.</p>
                        </div>
                        <div className='hover:bg-gray-200 dark:hover:bg-gray-800 p-3 transition-all rounded'>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Maintenez les lumières de votre entreprise allumées avec des flux de travail personnalisables, itératifs et structurés conçus pour toutes les équipes et tous les individus efficaces.</p>
                        </div>
                    </div>
                </div>
            </section>
